...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { name: 'Linkedin', href: 'https://wa.me/628123456789', icon: Linkedin },
  ];
            ...
            {socialLinks.map((social) => {
              ...
              return (
                <a
                  ...
                  className="text-white hover:text-green-100 transition-colors p-2 rounded-full bg-green-700 hover:bg-green-500"
        ...
        <div>
          ...
          <ul className="space-y-3 text-green-100">
            ...
            <li className="flex items-center gap-2">
              ...
              <a href="mailto:info@mervaharamain.com" className="hover:text-white">
